 ...
 * Generated at: 2025-03-19 08:54:45 UTC
...
public final class enterprise_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <a href=\"#\" class=\"dropdown-toggle\" id=\"enterpriseDropdown\" data-toggle=\"dropdown\" aria-haspopup=\"true\"\n");
      ...
      out.write("                                <input type=\"text\" class=\"form-control\" id=\"enterpriseId\"\n");
      ...
      out.write("                            </div>\n");
      out.write("                            <div class=\"col-md-3 mb-2\">\n");
      out.write("                                <button type=\"button\" class=\"btn btn-success btn-block\" onclick=\"addNewEnterprise()\">Add\n");
      ...
      out.write("\n");
      out.write("            // Log the full data for debugging\n");
      out.write("            console.log(\"Enterprises data:\", enterprises);\n");
      out.write("\n");
      out.write("            enterprises.forEach(function (enterprise, index) {\n");
      out.write("                const row = document.createElement('tr');\n");
      out.write("\n");
      out.write("                // Extract ID and ensure consistency\n");
      out.write("                const id = enterprise.enterpriseID || enterprise.id || enterprise.ID || '';\n");
      out.write("                console.log(`Enterprise ");
      ...
      out.write(" ID:`, id);\n");
      out.write("\n");
      out.write("                // å°IDå­å¨ä¸ºè¡çæ°æ®å±æ§\n");
      out.write("                row.setAttribute('data-enterprise-id', id);\n");
      out.write("\n");
      out.write("                // ä½¿ç¨jQueryç»å®åå»äºä»¶ä»¥ç¡®ä¿å¯é æ§\n");
      out.write("                $(row).dblclick(function () {\n");
      out.write("                    const clickedId = $(this).attr('data-enterprise-id');\n");
      out.write("\n");
      out.write("                    showEnterpriseDetail(clickedId);\n");
      out.write("                });\n");
      out.write("\n");
      out.write("                // Enterprise ID column\n");
      out.write("                const idCell = document.createElement('td');\n");
      out.write("                idCell.textContent = id;\n");
      ...
      out.write("            });\n");
      out.write("\n");
      out.write("            // å¨æ¸²æå®æåæ·»å è°è¯ä¿¡æ¯\n");
      out.write("            console.log(\"Table rendering complete, rows count:\", $('#resultsBody tr').length);\n");
      out.write("        }\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("            if (!id) {\n");
      out.write("                console.error(\"å°è¯æ¥çè¯¦æä½ä¼ä¸IDä¸ºç©º\");\n");
      out.write("                alert(\"æ æ³æ¾ç¤ºä¼ä¸è¯¦æï¼ç¼ºå°ä¼ä¸ID\");\n");
      out.write("                return;\n");
      out.write("            }\n");
      out.write("            // è½¬ä¹$ç¬¦å·é²æ­¢JSPè¯¯è§£ä¸ºELè¡¨è¾¾å¼\n");
      out.write("            const url = \"singleEnterprise.jsp?id=\" + encodeURIComponent(id.trim());\n");
      out.write("\n");
      ...
      out.write("            document.getElementById('noResults').style.display = 'block';\n");
      out.write("            document.getElementById('noResults').innerHTML =\n");
      out.write("                '<p class=\"text-center text-muted\">Enter search criteria and click \"Search\" to find enterprises.</p>';\n");
      out.write("\n");
      out.write("\n");
