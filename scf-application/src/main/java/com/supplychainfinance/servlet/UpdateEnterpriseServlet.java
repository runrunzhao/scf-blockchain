...
public class UpdateEnterpriseServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            enterprise.setEnterpriseID(jsonObject.get("id").getAsString());
            ...
            if (success) {
                responseJson.addProperty("message", "Enterprise updated successfully");
            } else {
                responseJson.addProperty("message", "Failed to update enterprise");
            }
