        ...
        <div class="container">
            ...
            <div class="card mb-4">
                <div class="card-header bg-primary text-white">
                    <i class="fas fa-edit mr-2"></i>Step1: Generate Util SC (Transfer Contract ~75s)
                </div>
                <div class="card-body">
                    <form id="scTransForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="scTransAddressinDB" name="scTransAddressinDB" " required readonly>
                        </div>
                        ...
                        <div class="card bg-light">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="scTransAddressDisplayFromBlock"><strong>SCTrans
                                            BlockChain:</strong></label>
                                    <!-- Removed input-group -->
                                    <input type="text" class="form-control" id="scTransAddressDisplayFromBlock"
                                        readonly>
                                </div>
                                ...
                                <div class="form-row mt-3 justify-content-around">
                                    ...
                                    <div class="col-auto">
                                        <button id="saveScTransBtnFromBlock" class="btn btn-outline-success"
                                            type="button" onclick="saveSCTransAddress2DB()">
                        ...
                        <div class="card mb-4">
                            <div class="card-header bg-primary text-white">
                                <i class="fas fa-edit mr-2"></i>Step2: Generate Manage SC (Multi-Sig ~60s)
                            </div>
                            <div class="card-body">
                                <form id="scMultiForm">
                                    <div class="form-group">
                                        <label for="scTransAddressinDB">SCTrans Address:</label>
                                        <input type="text" class="form-control" id="scTransAddressinDB2"
                                            name="scTransAddressinDB2"
                                            placeholder="Shower  SmartContract Address (0x...)" required readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="scMultiTransAddress">SCMulti Address:</label>
                                        <input type="text" class="form-control" id="scMultiTransAddress"
                                            name="scMultiTransAddress" placeholder="Shower Multi SmartContract in DB"
                                            required readonly>
                                    </div>
                                    ...
                                    <div class="form-row mb-4">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="multiAddress1"
                                                name="multiAddress1" placeholder="Enter Manage address (0x...)"
                                                required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="multiAddress2">Multi Address2:</label>
                                            <input type="text" class="form-control" id="multiAddress2"
                                                name="multiAddress2" placeholder="Enter Manage Address (0x...)"
                                                required>
                                        </div>
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="form-row mb-4">
                                        <div class="col-md-4">
                                            <button type="button" id="searchScMultiBtn"
                                                class="btn btn-success btn-block">
                                                <i class="fas fa-search mr-1"></i> Search Latest SCMulti from Server
                                            </button>
                                        </div>
                                        <div class="col-md-4">
                                            <button type="button" id="saveScMultiBtn"
                                                class="btn btn-generate btn-block">
                                                <i class="fas fa-save mr-1"></i> Save SCMulti to Server
                                            </button>
                                        </div>
                                        <div class="col-md-4">
                                            <button type="button" id="deployScMultiBtn"
                                 ...
                                 <!-- Contract Address Display Section -->
                                    ...
                                    <div class="card bg-light">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="scMultiAddressDisplayFromBlock"><strong>SCMulti
                                                        BlockChain:</strong></label>
                                                <!-- Removed input-group -->
                                                <input type="text" class="form-control"
                                                    id="scMultiAddressDisplayFromBlock" readonly>
                                            </div>

                                            <div class="form-group"> <!-- Adjusted margin -->
                                                <label for="scMultiCreateTimeDisplay"><strong>SCMulti
                                                        CreateTime:</strong></label>
                                                <input type="text" class="form-control" id="scMultiCreateTimeDisplay"
                                                    readonly>
                                            </div>
                                            ...
                                            <div class="form-row mt-3 justify-content-around">
                                                ...
                                                <div class="col-auto">
                                                    <!-- Corrected button ID to match the one used in saveSCMultiAddress2DB if needed, or keep as is if distinct -->
                                                    <button id="saveScMultiAddressBtn" class="btn btn-outline-success"
                                                        type="button" onclick="saveSCMultiAddress2DB()">
                                                        <i class="fas fa-save"></i> Save to DB
                                                    </button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <i class="fas fa-edit mr-2"></i>Step3: Generate Connections ( ~40s)
                                        </div>
                                        <div class="card-body">
                                            <form id="scConnectionForm">
                                                <div class="form-group">
                                                    <label for="connScTransAddress">SCTrans Address:</label>
                                                    <input type="text" class="form-control" id="connScTransAddress"
                                                        name="connScTransAddress"
                                                        placeholder="Show SCTrans Address (0x...)" required readonly>
                                                </div>

                                                <div class="form-group">
                                                    <label for="connScMultiAddress">SCMulti Address:</label>
                                                    <input type="text" class="form-control" id="connScMultiAddress"
                                                        name="connScMultiAddress"
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <button type="button" id="saveSCConnectionsBtn"
                                                            class="btn btn-generate btn-block">Save
                                                            Connections to Server
                                                        </button>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <button type="button" id="signSCConnectionsBtn"
                                                            class="btn btn-warning btn-block">Sign
                                    ...
                                    <script>
                                        ...
                                        async function findContractByType(transactions, contractType) {
                                            ...
                                            if (!window.web3) {
                                                console.error("Web3 is not initialized in findContractByType.");
                                                showStatus("Wallet not connected or Web3 not initialized.", true);
                                                return null;
                                            }
                                            if (!transactions || transactions.length === 0) {
                                                console.log("No transactions provided to findContractByType.");
                                                return null;
                                            }

                                            // Filter for valid contract creation transactions first
                                            const validTransactions = transactions.filter(tx =>
                                                tx && tx.contractAddress &&
                                                window.web3.utils.isAddress(tx.contractAddress) &&
                                                (tx.to === "" || tx.to === null) && // Explicitly check for creation TX
                                                tx.isError === "0" // Ensure transaction was successful
                                            );

                                            console.log(`Found ${validTransactions.length} valid successful contract creation transactions`);
                                            if (validTransactions.length === 0) {
                                                console.log("No valid contract creation transactions found.");
                                                return null;
                                            }
                                            ...
                                            for (const tx of validTransactions) {
                                                try {
                                                    ...
                                                    // Skip if no code exists (not a contract or destroyed)
                                                    if (code === '0x' || code === '0x0') {
                                                        //console.log(`Skipping ${tx.contractAddress} - no bytecode found.`);
                                                        continue;
                                                    }

                                                    let confidence = 0;
                                                    let contractInstance; // Define contractInstance outside the specific type blocks

                                                    if (contractType === 'SCTrans') {
                                                        // Use safer method calls with individual try/catch blocks
                                                        contractInstance = new window.web3.eth.Contract(
                                                            customTokenTransferABI, // Ensure this ABI is defined globally or passed
                                                            tx.contractAddress
                                                        );

                                                        try {
                                                            await contractInstance.methods.name().call();
                                                            //console.log(`Contract ${tx.contractAddress} has name()`);
                                                            confidence += 25;
                                                        } catch (e) { /* console.log(`Contract ${tx.contractAddress} lacks name()`); */ }

                                                        try {
                                                            await contractInstance.methods.symbol().call();
                                                            //console.log(`Contract ${tx.contractAddress} has symbol()`);
                                                            confidence += 25;
                                                        } catch (e) { /* console.log(`Contract ${tx.contractAddress} lacks symbol()`); */ }

                                                        try {
                                                            await contractInstance.methods.totalSupply().call();
                                                            //console.log(`Contract ${tx.contractAddress} has totalSupply()`);
                                                            confidence += 25;
                                                        } catch (e) { /* console.log(`Contract ${tx.contractAddress} lacks totalSupply()`); */ }

                                                        try {
                                                            await contractInstance.methods.owner().call();
                                                            //console.log(`Contract ${tx.contractAddress} has owner()`);
                                                            confidence += 25;
                                                        } catch (e) { /* console.log(`Contract ${tx.contractAddress} lacks owner()`); */ }

                                                    } else if (contractType === 'SCMulti') {
                                                        // Add specific checks for SCMulti contract
                                                        contractInstance = new window.web3.eth.Contract(
                                                            customTokenMultiABI, // Ensure this ABI is defined globally or passed
                                                            tx.contractAddress
                                                        );

                                                        try {
                                                            await contractInstance.methods.requiredConfirmations().call();
                                                            //console.log(`Contract ${tx.contractAddress} has requiredConfirmations()`);
                                                            confidence += 30;
                                                        } catch (e) { /* console.log(`Contract ${tx.contractAddress} lacks requiredConfirmations()`); */ }

                                                        try {
                                                            await contractInstance.methods.tokenContract().call();
                                                            //console.log(`Contract ${tx.contractAddress} has tokenContract()`);
                                                            confidence += 30;
                                                        } catch (e) { /* console.log(`Contract ${tx.contractAddress} lacks tokenContract()`); */ }

                                                        try {
                                                            await contractInstance.methods.getTransactionCount().call();
                                                            //console.log(`Contract ${tx.contractAddress} has getTransactionCount()`);
                                                            confidence += 20;
                                                        } catch (e) { /* console.log(`Contract ${tx.contractAddress} lacks getTransactionCount()`); */ }

                                                        try {
                                                            // SCMulti might also have an owner (if Ownable)
                                                            await contractInstance.methods.owner().call();
                                                            //console.log(`Contract ${tx.contractAddress} has owner()`);
                                                            confidence += 20;
                                                        } catch (e) { /* console.log(`Contract ${tx.contractAddress} lacks owner()`); */ }
                                                    ...
                                                    // Only add if confidence is reasonably high for the specific type
                                                    if (confidence >= 50) { // Threshold might need adjustment (e.g., 50 for SCTrans, 60 for SCMulti)
                                                        potentialMatches.push({ tx, confidence });
                                                        console.log(`Potential ${contractType} match: ${tx.contractAddress} with confidence ${confidence}`);
                                                    } else {
                                                        //console.log(`Skipping ${tx.contractAddress} for ${contractType} - low confidence (${confidence})`);
                                                    }

                                                } catch (error) {
                                                    // Log errors more specifically if possible
                                                    if (error.message.includes("Returned values aren't valid")) {
                                                        console.warn(`Contract at ${tx.contractAddress} might not match ABI or is not the expected type.`);
                                                    } else {
                                                        console.error(`Error examining contract ${tx.contractAddress}:`, error.message);
                                                    }
                                                }
                                            }
                                            ...
                                            potentialMatches.sort((a, b) => {
                                                ...
                                                // If confidence is the same, prefer the newer transaction
                                                return parseInt(b.tx.timeStamp) - parseInt(a.tx.timeStamp);
                                            });


                                            if (potentialMatches.length > 0) {
                                                console.log(`Found ${potentialMatches.length} potential ${contractType} contracts - using best match: ${potentialMatches[0].tx.contractAddress} with ${potentialMatches[0].confidence} confidence`);
                                                return potentialMatches[0].tx; // Return the transaction object of the best match
                                            }

                                            // Fallback: If no confident match, return the latest valid contract creation TX (less reliable)
                                            console.warn(`No confident ${contractType} contract found based on method checks. Falling back to the absolute latest contract creation transaction if available.`);
                                            // validTransactions is already sorted by the API (desc), so the first one is the latest
                                            if (validTransactions.length > 0) {
                                                // Sort valid transactions by timestamp descending just to be sure
                                                validTransactions.sort((a, b) => parseInt(b.timeStamp) - parseInt(a.timeStamp));
                                                console.log(`Using fallback: latest contract transaction ${validTransactions[0].contractAddress}`);
                                                return validTransactions[0]; // Return the latest valid transaction object
                                            }


                                            console.error(`No suitable ${contractType} contract found.`);
                                    ...
                                    <script>
                                                ...
                                                .then(data => {
                                                    if (data.success) {
                                                        ...
                                                        if (data.tokenId) {
                                                            ...
                                                            document.getElementById('scTransRecipientAddress').value = "";
                                                        }
                                        ...
                                        function saveScMultiToDB() {
                                            // Validate form before submission
                                            const scTransAddress = document.getElementById('scTransAddressinDB2').value;
                                            ...
                                            // Prepare form data
                                            const formData = new URLSearchParams();
                                            formData.append('scTransAddress', scTransAddress);
                                            ...
                                            fetch('saveScMulti', {
                                                ...
                                                .then(data => {
                                                    if (data.success) {
                                                        // Update token ID if returned
                                                        if (data.multiTokenID) {
                                                            document.getElementById('scMultiTokenID').value = data.multiTokenID;
                                                        }
                                        ...
                                        function copyContractAddress() {
                                            const contractAddressEl = document.getElementById('scTransAddressDisplayFromBlock');
                                        ...
                                        function saveSCTransAddress2DB() {
                                            ...
                                            const contractAddress = document.getElementById('scTransAddressDisplayFromBlock').value;
                                        ...
                                        async function deployScTransToBlock() {
                                            ...
                                            try {
                                                ...
                                                showStatus("Deploying contract, please wait and then Refresh...");
                                        ...
                                        function refreshScTransAddress() {
                                            refreshContractAddress('scTransAddressDisplayFromBlock', 'scTransCreateTimeDisplay', 'SCTrans')
                                                .then(() => {
                                                    // After refresh completes, propagate the address to other fields
                                                    const scTransAddress = document.getElementById('scTransAddressDisplayFromBlock').value;
                                        ...
                                        function updateAllScTransAddressFields(scTransAddress) {
                                            ...
                                            const scTransAddressinDB2 = document.getElementById('scTransAddressinDB2');
                                            if (scTransAddressinDB2) {
                                                scTransAddressinDB2.value = scTransAddress;
                                            }
                                        ...
                                        function refreshScMultiAddress() {
                                            refreshContractAddress('scMultiAddressDisplayFromBlock', 'scMultiCreateTimeDisplay', 'SCMulti')
                                                .then(() => {
                                                    // After refresh completes, propagate the address to Step 3
                                                    const scMultiAddress = document.getElementById('scMultiAddressDisplayFromBlock').value;
                                                    document.getElementById('scMultiTransAddress').value=scMultiAddress;
                                        ...
                                        function saveSCMultiAddress2DB() {
                                            ...
                                            const contractAddress = document.getElementById('scMultiTransAddress').value;
