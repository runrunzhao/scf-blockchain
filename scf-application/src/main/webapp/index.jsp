                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-md-6">
                                                <%  Enterprise coreEnterprise=null; 
                                                    ...
                                                    if (coreEnterprise==null) { EnterpriseDAO dao=new
                                                    EnterpriseDAO(); coreEnterprise=dao.getCoreEnterprise(); } if
                                                    (coreEnterprise !=null) { %>
                                                    <div class="core-enterprise"
                                                        onclick="navigateToEnterpriseDetail('<%= coreEnterprise.getEnterpriseID() %>')">
                                                        <h3>Core Enterprise</h3>
                                                        <p><strong>Core Enterprise Name:</strong>
                                                            <%= coreEnterprise.getEnterpriseName() %>
                                                        </p>
                                                        <p><strong>Core Enterprise ID:</strong>
                                                            <%= coreEnterprise.getEnterpriseID() %>
                                                        </p>
                                                        <p><strong>Contact:</strong>
                                                            <%= coreEnterprise.getTelephone() %>
                                                        </p>
                                                        <button class="btn btn-primary"
                                                            onclick="event.stopPropagation(); window.location.href='enterpriseDetail.jsp?id=<%= coreEnterprise.getEnterpriseID() %>';">SCDetails</button>
                                                    </div>
                                                    <% } else { %>
                                                        <div class="core-enterprise">
                                                            <h3>Core Enterprise</h3>
                                                            <p>No core enterprise found in the database.</p>
                                                            <p>Please add a core enterprise through the Enterprise menu.
                                                            </p>
                                                            <a href="singleEnterprise.jsp?mode=add"
                                                                class="btn btn-primary">Add Core Enterprise</a>
                                                        </div>
                                                        <% } %>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <%  List<Enterprise> suppliers = null;
                                                ...
                                                <div class="core-enterprise mb-3"
                                                    onclick="navigateToEnterpriseDetail('<%= supplier.getEnterpriseID() %>')">
                                                    <h5>
                                                    ...
                                                    <p><strong>Contact:</strong>
                                                        <%= supplier.getTelephone() !=null ? supplier.getTelephone()
                                                            : "N/A" %>
                                                    </p>
                                                    <button class="btn btn-primary"
                                                        onclick="event.stopPropagation(); window.location.href='enterpriseDetail.jsp?id=<%= supplier.getEnterpriseID() %>';">SCDetails</button>
                                                </div>
                                                <% } } else { %>
                                                    <div class="core-enterprise mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <% List<Enterprise> distributors = null;
                                                ...
                                                %>
                                                <div class="core-enterprise mb-3"
                                                    onclick="navigateToEnterpriseDetail('<%= distributor.getEnterpriseID() %>')">
                                                    <h5>
                                                        <%= distributor.getEnterpriseName() %>
                                                    </h5>
                                                    <p><strong>Enterprise ID:</strong>
                                                        <%= distributor.getEnterpriseID() %>
                                                    </p>
                                                    <p><strong>Type:</strong> Distributor (Tier 1)</p>
                                                    <p><strong>Contact:</strong>
                                                        <%= distributor.getTelephone() !=null ?
                                                            distributor.getTelephone() : "N/A" %>
                                                    </p>
                                                    <button class="btn btn-primary"
                                                        onclick="event.stopPropagation(); window.location.href='enterpriseDetail.jsp?id=<%= distributor.getEnterpriseID() %>';">SCDetails</button>
                                                </div>
                                                <% } } else { %>
                                                    <div class="core-enterprise mb-3">
                                                        ...
                                                        <a href="singleEnterprise.jsp?mode=add"
                                                            class="btn btn-primary">Add Distributor</a>
                                                    </div>
                                                    <% } %>
                                        </div>
                                    </div>
